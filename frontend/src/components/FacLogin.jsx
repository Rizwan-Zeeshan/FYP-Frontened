...
export default function FacLogin({ initialUserId = "FAC-1", userType = "faculty" }) {
    ...
    const idRegex = new RegExp(`^${idPrefix}-\\d+$`, "i"); // Allow any number of digits
                ...
                <form onSubmit={handleSubmit} style={styles.form} noValidate>
                    <div style={styles.field}>
                        ...
                        <input
                            ...
                            placeholder={userId || initialUserId || `${idPrefix}-23`}
                        />
                        {touched.userId && !userIdIsValid && (
                            <div style={styles.error}>
                                User ID must match {idPrefix}-N (e.g. {idPrefix}-1).
                            </div>
                        )}
                    </div>
                    ...
                    {errorMessage && (
                        <div style={{ ...styles.error, marginTop: 12, textAlign: "center" }}>
                            {errorMessage}
                        </div>
                    )}
                </form>
